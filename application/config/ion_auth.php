...
$config['admin_group']                = 'admin';             // Default administrators group, use name, Def email
$config['identity']                   = 'username';          // A database column which is used to login with. 
$config['min_password_length']        = 6;                   // Minimum Required Length of Password, Def 8
$config['max_password_length']        = 20;                  // Maximum Allowed Length of Password
$config['email_activation']           = FALSE;               // Email Activation for registration
$config['manual_activation']          = FALSE;               // Manual Activation for registration
$config['remember_users']             = FALSE;               // Allow users to be remembered and enable auto-login, Def TRUE
$config['user_expire']                = 900;                 // How long to remember the user (seconds). Set to zero for no expiration, Def 86500(24h)
$config['user_extend_on_login']       = TRUE;               // Extend the users cookies every time they auto-login, Def FALSE
$config['track_login_attempts']       = TRUE;               // Track the number of failed login attempts for each user or ip., Def FALSE
$config['track_login_ip_address']     = TRUE;                // Track login attempts by IP Address, if FALSE will track based on identity. (Default: TRUE)
$config['maximum_login_attempts']     = 0;                   // The maximum number of failed login attempts., Def 3
